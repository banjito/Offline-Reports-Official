// TanDeltaChartReport.tsx - Medium Voltage VLF Tan Delta Test ATS Report
// Matches: medium-voltage-vlf-tan-delta (4-Medium Voltage Cable VLF Tan Delta Test ATS)
// Database table: tandelta_reports
...
const initialData: TanDeltaDataPoint[] = [
  { voltageLabel: '0.5 Uo', kV: 8, phaseA: 0, phaseAStdDev: null, phaseB: 0, phaseBStdDev: null, phaseC: 0, phaseCStdDev: null },
  { voltageLabel: '1.0 Uo', kV: 16, phaseA: 0, phaseAStdDev: null, phaseB: 0, phaseBStdDev: null, phaseC: 0, phaseCStdDev: null },
  { voltageLabel: '1.5 Uo', kV: 24, phaseA: 0, phaseAStdDev: null, phaseB: 0, phaseBStdDev: null, phaseC: 0, phaseCStdDev: null },
  { voltageLabel: '2.0 Uo', kV: 32, phaseA: 0, phaseAStdDev: null, phaseB: 0, phaseBStdDev: null, phaseC: 0, phaseCStdDev: null },
];
...
interface TanDeltaChartReportProps {
  reportId?: string;
  jobId?: string;
  job?: any;
  isEditing?: boolean;
...
const TanDeltaChartReport: React.FC<TanDeltaChartReportProps> = ({
  job,
  isEditing = false,
  onSave,
    ...
    <div className="report-container">
      ...
      <div className="print-header">
        ...
        <div className="print-title">
          <h1>4-Medium Voltage Cable VLF Tan Delta Test ATS</h1>
          <p className="neta-ref">NETA - ATS 7.3.3</p>
        </div>
            ...
            <tbody>
              {formData.data.map((row, index) => (
                <tr key={index}>
                  ...
                  <td>{editingData ? <input type="number" value={row.kV} onChange={(e) => handleDataChange(index, 'kV', e.target.value)} className="table-input" /> : row.kV}</td>
...
export default TanDeltaChartReport;
