// MediumVoltageVLFATSReport.tsx - Medium Voltage Cable VLF Test ATS Report
// Matches: medium-voltage-vlf (4-Medium Voltage Cable VLF Test ATS)
...
interface FormData {
  ...
  // Visual Inspection
  visualInspection: {
    compareData: InspectionResult;
    inspectDamage: InspectionResult;
    useOhmmeter: InspectionResult;
    inspectConnectors: InspectionResult;
    inspectGrounding: InspectionResult;
    verifyBends: InspectionResult;
    inspectCurrentTransformers: InspectionResult;
    inspectIdentification: InspectionResult;
    inspectJacket: InspectionResult;
  };
...
const initialFormData: FormData = {
  ...
  visualInspection: {
    compareData: InspectionResult.SELECT,
    inspectDamage: InspectionResult.SELECT,
    useOhmmeter: InspectionResult.SELECT,
    inspectConnectors: InspectionResult.SELECT,
    inspectGrounding: InspectionResult.SELECT,
    verifyBends: InspectionResult.SELECT,
    inspectCurrentTransformers: InspectionResult.SELECT,
    inspectIdentification: InspectionResult.SELECT,
    inspectJacket: InspectionResult.SELECT
  },
...
interface MediumVoltageVLFATSReportProps {
  reportId?: string;
  jobId?: string;
  job?: any;
  isEditing?: boolean;
...
const MediumVoltageVLFATSReport: React.FC<MediumVoltageVLFATSReportProps> = ({
  job,
  isEditing = false,
  onSave,
    ...
    <div className="report-container">
      ...
      <div className="print-header">
        ...
        <div className="print-title">
          <h1>4-Medium Voltage Cable VLF Test ATS</h1>
          <p className="neta-reference">NETA - ATS 7.3.3</p>
        </div>
        ...
        <table className="data-table">
          <tbody>
            ...
            <tr>
              ...
              <td className="label-cell">Operating Voltage:</td>
              <td><input type="text" value={formData.cableInfo.operatingVoltage} onChange={(e) => handleNestedChange('cableInfo', 'operatingVoltage', e.target.value)} readOnly={!isEditing} className="table-input" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="label-cell">Conductor Material:</td>
              <td><input type="text" value={formData.cableInfo.conductorMaterial} onChange={(e) => handleNestedChange('cableInfo', 'conductorMaterial', e.target.value)} readOnly={!isEditing} className="table-input" /></td>
            </tr>
          </tbody>
        </table>
        </div>
      ...
      <div className="report-section">
        ...
        <table className="data-table">
            ...
            <tr>
              <td>7.3.3.A.1</td>
              <td>Compare equipment nameplate data with drawings and specifications</td>
              <td>
                <select value={formData.visualInspection.compareData} onChange={(e) => handleNestedChange('visualInspection', 'compareData', e.target.value)} disabled={!isEditing} className="table-input">
            ...
            <tr>
              <td>7.3.3.A.2</td>
              <td>Inspect cables for physical damage and proper support</td>
              <td>
                <select value={formData.visualInspection.inspectDamage} onChange={(e) => handleNestedChange('visualInspection', 'inspectDamage', e.target.value)} disabled={!isEditing} className="table-input">
                  {inspectionOptions.map(opt => <option key={opt} value={opt}>{opt}</option>)}
                </select>
              </td>
            </tr>
            ...
            <tr>
              <td>7.3.3.A.4</td>
              <td>Inspect terminations, splices, and connectors</td>
              <td>
                <select value={formData.visualInspection.inspectConnectors} onChange={(e) => handleNestedChange('visualInspection', 'inspectConnectors', e.target.value)} disabled={!isEditing} className="table-input">
                  {inspectionOptions.map(opt => <option key={opt} value={opt}>{opt}</option>)}
                </select>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <select value={formData.visualInspection.verifyBends} onChange={(e) => handleNestedChange('visualInspection', 'verifyBends', e.target.value)} disabled={!isEditing} className="table-input">
                  {inspectionOptions.map(opt => <option key={opt} value={opt}>{opt}</option>)}
                </select>
              </td>
            </tr>
            ...
            <tr>
              <td>7.3.3.A.9</td>
              <td>Verify proper cable identification</td>
              <td>
                <select value={formData.visualInspection.inspectIdentification} onChange={(e) => handleNestedChange('visualInspection', 'inspectIdentification', e.target.value)} disabled={!isEditing} className="table-input">
                  {inspectionOptions.map(opt => <option key={opt} value={opt}>{opt}</option>)}
                </select>
              </td>
            </tr>
            <tr>
              <td>7.3.3.A.10</td>
              <td>Inspect cable jacket for damage</td>
              <td>
                <select value={formData.visualInspection.inspectJacket} onChange={(e) => handleNestedChange('visualInspection', 'inspectJacket', e.target.value)} disabled={!isEditing} className="table-input">
                  {inspectionOptions.map(opt => <option key={opt} value={opt}>{opt}</option>)}
                    </select>
                  </td>
                </tr>
        ...
        <table className="data-table">
          <tbody>
            <tr>
              ...
              <td><input type="text" value={formData.temperature.tcf.toFixed(3)} readOnly className="table-input" style={{ backgroundColor: '#f0f0f0' }} /></td>
            </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="report-section">
        ...
        <table className="data-table">
            ...
            <tbody>
              ...
              <td><input type="text" value={formData.equipment.ohmmeterAmpId} onChange={(e) => handleNestedChange('equipment', 'ohmmeterAmpId', e.target.value)} readOnly={!isEditing} className="table-input" /></td>
              </tr>
              <tr>
              ...
              <td><input type="text" value={formData.equipment.megohmmeterAmpId} onChange={(e) => handleNestedChange('equipment', 'megohmmeterAmpId', e.target.value)} readOnly={!isEditing} className="table-input" /></td>
              </tr>
              <tr>
...
export default MediumVoltageVLFATSReport;
